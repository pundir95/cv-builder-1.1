  ...
  return (
    <div className="lg:p-8 space-y-6">
      <div className="lg:flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight lg:mb-0 mb-4">{t`Users`}</h1>
      ...
      {/* Tabs */}
      <div className="flex flex-wrap gap-2 border-b border-gray-300 mb-2">
        <button
          ...
          <table className="w-full">
            <thead>
              <tr className="border-lg bg-blue-500 hover:bg-blue-600 text-white">
                ...
                <th className="text-left p-4 font-medium whitespace-nowrap">{t`Last Active`}</th>
            ...
            <tbody>
              {filteredUsers.map((user: any) => (
                <tr key={user.id} className="border-b bg-white">
                  <td className="p-4 font-medium whitespace-nowrap">{user.first_name} {user.last_name}</td>
