...
export const Page = ({ mode = "preview", pageNumber, children }: Props) => {
  ...
  return (
    <div
      className={`w-full max-w-[646px] ml-auto mr-auto max-[768px]:absolute max-[768px]:left-1/2 max-[768px]:-translate-x-1/2 relative block ${mode === "preview" ? "preview-class" :""}`}
